...
static uint32_t s_eepromStartAddr = EFLASH_ADDRESS_END - EFLASH_PAGE_SIZE; /* eeprom start address in eflash */
...
void SWEEPROM_Init(uint16_t size, uint32_t pageIndex)
{
    ...
    s_eepromSize = size;
    s_eepromStartAddr = EFLASH_ADDRESS_BASE + pageIndex * EFLASH_PAGE_SIZE;
 ...
 */
EFLASH_STATUS WriteDataToEflash(uint32_t writeFlashStartAddr, uint16_t eepromAddr, const uint16_t *dataBuffer, uint16_t writeNum)
{
 ...
 */
static EFLASH_STATUS CopyDataToNewArea(uint32_t newAreaStartAddr, uint32_t oldAreaStartAddr)
{
    EFLASH_STATUS statusRes = EFLASH_STATUS_SUCCESS;
 ...
 * @return statusRes: software eeprom write status
 */
static EFLASH_STATUS UpdateOperateAddr(uint32_t *newStartAddr, uint32_t *oldStartAddr)
{
    EFLASH_STATUS statusRes = EFLASH_STATUS_SUCCESS;
 ...
 * @return statusRes: software eeprom write status
 */
EFLASH_STATUS SWEEPROM_WriteExt(uint16_t writeAddr, const uint16_t *dataBuffer, uint16_t writeNum)
{
    EFLASH_STATUS statusRes = EFLASH_STATUS_SUCCESS;
    uint32_t leftSize = 0;
 ...
 * @return statusRes: software eeprom write status
 */
EFLASH_STATUS SWEEPROM_Write(uint16_t writeAddr, const uint16_t *dataBuffer, uint16_t writeNum)
{
    EFLASH_STATUS statusRes = EFLASH_STATUS_SUCCESS;
 ...
 */
EFLASH_STATUS SWEEPROM_Read(uint16_t readAddr, uint16_t *dataBuffer, uint16_t readNum)
{
    EFLASH_STATUS statusRes = EFLASH_STATUS_SUCCESS;
